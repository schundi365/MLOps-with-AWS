#!/usr/bin/env python3
"""Check detailed execution history for Execution #24."""
...
def main():
    region = 'us-east-1'
    execution_arn = 'arn:aws:states:us-east-1:327030626634:execution:MovieLensMLPipeline:execution-20260122-111111-355'
    
    sfn_client = boto3.client('stepfunctions', region_name=region)
    
    print("\n" + "="*70)
    print("EXECUTION #24 DETAILED HISTORY")
    print("="*70)
    print()
